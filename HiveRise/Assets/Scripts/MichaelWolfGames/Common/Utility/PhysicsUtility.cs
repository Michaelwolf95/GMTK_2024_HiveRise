...
// Ditzelgames PhysicsHelper
// https://www.youtube.com/watch?v=BNiAt0HnC5M
// https://gist.github.com/ditzel/1f207c838f0023fcbd34c5c67955fd25
namespace MichaelWolfGames
{
	public static class PhysicsUtility
	{
        ...
        //-///////////////////////////////////////////////////////////
        ///
        public static bool OverlapCollider(this Collider colliderA, Collider colliderB)
        {
            return Physics.ComputePenetration(colliderA, colliderA.transform.position, colliderA.transform.rotation,
                colliderB, colliderB.transform.position, colliderB.transform.rotation, out _, out _);
        }

        //-///////////////////////////////////////////////////////////
        /// 
        public static Bounds GetCombinedBoundingBoxOfColliders(List<Collider> colliders)
        {
